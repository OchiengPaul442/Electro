{{-- special offer products display --}}
@php $i = 0; @endphp
@while ($i < 4)
    <div class="w-full max-w-sm bg-white rounded-lg transition-shadow hover:shadow-lg">
        ...
        <div class="p-2">
            <a href="#">
                <h5 class="text-sm font-medium tracking-tight text-gray-900 hover:text-w-orange">
                    Apple Watch
